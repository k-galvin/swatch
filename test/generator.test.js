...
const fixtures = [
  ...
  },
  {
    ...
    expected: [
      //,
      /<line x1="0" y1="0" x2="100" y2="0" stroke="#000000" stroke-width="10" stroke-linecap="round" \/>/,
      /<circle cx="250" cy="250" r="12" fill="#a52a2a" \/>/,
  ...
  },
  {
    ...
    expected: [/stroke="black" stroke-width="4"/, /fill="#3498db"/],
  },
];
